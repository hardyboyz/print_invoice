...
$pdf = '<div class="pdf_area">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        <tr>
            ...
            <td width="40%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Description</td>
            ...
            if(UOM == 1){
                $pdf .='<td width="7%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="7%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM QTY</td>';
            }
        ...
        <tr>
            <td valign="top" valign="top" align="center" width="5%" style="border-bottom: none;border-left: 1px solid; border-left: 1px solid; padding: 5px;  font:12px arial">' . $i . '</td>
            <td valign="top" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['description'] . '</td>
            <td valign="top" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['description_short'] . '</td>
            <td valign="top" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td valign="top" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td valign="top" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td valign="top" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
       ...
       <tr>
          ...
          if(UOM_QTY == 1){
            ...
            $pdf .=add_col($discount_col,1);

            $pdf .='<td colspan="3" style="border:1px solid; border-left:1px solid;">
        ...
        if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>GST @ 6%</b></td>
