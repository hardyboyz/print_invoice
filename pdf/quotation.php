...
$pdf = '<div class="pdf_area">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            ...
            if(UOM == 1){
                $pdf .='<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
