...
$pdf = '<div class="pdf_area">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        <tr bgcolor="#cccccc">
            <td style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid; border-right:none">No.</td>
            <td width="35%" style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Description</td>
            <td style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">GST</td>
            <td style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Unit Price</td>
            <td style="width:15px;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">Qty</td>';
        if(UOM == 1){
                $pdf .='<td style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM QTY</td>';
            }

            $pdf .= discount_col($discount_col);

            $pdf .='<td width="16%" style="font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Total</td>
        </tr>';
        ...
        <tr>
            ...
            <td valign="top" width="3%" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
